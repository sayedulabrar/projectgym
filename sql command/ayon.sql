...
("MEMBER_NAME","MEMBER_HEIGHT","MEMBER_WEIGHT","DATE_OF_BIRTH","ASSIGNED_DIET_ID","FOLLOWED_SET","ASSIGNED_TRAINER","TRAINER_RATING") 
AS 
SELECT NAME,MEM_HEIGHT,MEM_WEIGHT,DOB,DIET_ID,F_SET,TRAINER,RATING
FROM MEMBER JOIN USERS USING (USERNAME) 
