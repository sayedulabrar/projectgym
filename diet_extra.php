...
<<<<<<< Updated upstream
    ...
    $sql1 = "Select DIET_ID from Member where username='$val1'";
=======
...
>>>>>>> Stashed changes
        ...
        $update = "update MEMBER set DIET_ID=$diet_id WHERE USERNAME='$val1' and TRAINER='$trainer'";
        $stmt = oci_parse($conn, $update);
        $result = oci_execute($stmt);
...
<<<<<<< Updated upstream
  ...
  header("location: diet.php?un=$val1");
=======
